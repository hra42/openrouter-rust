...
pub use types::{
    ...
    ActivityResponse, Annotation, AudioFormat, ChatCompletionRequest, ChatCompletionResponse,
    Choice, CompletionRequest, CompletionResponse, Content, ContentBuilder, ContentPart,
    CreditsData, CreditsResponse, Delta, File, FileAnnotation, FileParserEngine, FilePdfConfig,
    FilePluginConfig, FileRef, FunctionCall, FunctionDef, ImageDetail, ImageUrl, InputAudio,
    KeyData, KeyRateLimit, KeyResponse, ListModelsOptions, Message, Model, ModelArchitecture,
    ModelDefaultParameters, ModelEndpoint, ModelEndpointPricing, ModelEndpointsArchitecture,
    ModelEndpointsData, ModelEndpointsResponse, ModelPerRequestLimits, ModelPricing,
    ModelTopProvider, ModelsResponse, Plugin, Provider, ProviderInfo, ProvidersResponse,
    ReasoningConfig, ResponseFormat, Role, Tool, ToolCall, ToolChoice, UrlCitation, Usage,
    WebPluginConfig,
};
